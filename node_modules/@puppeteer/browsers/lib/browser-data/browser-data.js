 ...
 */
import * as chromeHeadlessShell from './chrome-headless-shell.js?v=3';
import * as chrome from './chrome.js?v=3';
import * as chromedriver from './chromedriver.js?v=3';
import * as chromium from './chromium.js?v=3';
import * as firefox from './firefox.js?v=3';
import { Browser, BrowserPlatform, BrowserTag, ChromeReleaseChannel, verifyChromeReleaseChannel, } from './types.js?v=3';
 ...
 * @public
 *
 * Gets the first resolved system path
 */
