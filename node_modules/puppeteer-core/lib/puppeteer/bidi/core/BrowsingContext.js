...
import { isString } from '../../common/util.js?v=3';
import { assert } from '../../util/assert.js?v=3';
import { inertIfDisposed, throwIfDisposed } from '../../util/decorators.js?v=3';
import { DisposableStack, disposeSymbol } from '../../util/disposable.js?v=3';
import { BidiBluetoothEmulation } from '../BluetoothEmulation.js?v=3';
import { BidiDeviceRequestPromptManager } from '../DeviceRequestPrompt.js?v=3';
import { Navigation } from './Navigation.js?v=3';
import { WindowRealm } from './Realm.js?v=3';
import { Request } from './Request.js?v=3';
import { UserPrompt } from './UserPrompt.js?v=3';
/**
 * @internal
 */
let BrowsingContext = (() => {
