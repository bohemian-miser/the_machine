var _a;
import { HTTPRequest, STATUS_TEXTS, handleError, InterceptResolutionAction, } from '../api/HTTPRequest.js?v=3';
import { UnsupportedOperation } from '../common/Errors.js?v=3';
import { stringToBase64 } from '../util/encoding.js?v=3';
import { BidiHTTPResponse } from './HTTPResponse.js?v=3';
