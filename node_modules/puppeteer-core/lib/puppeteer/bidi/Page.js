...
import { Coverage } from '../cdp/Coverage.js?v=3';
import { EmulationManager } from '../cdp/EmulationManager.js?v=3';
import { Tracing } from '../cdp/Tracing.js?v=3';
import { ProtocolError, UnsupportedOperation } from '../common/Errors.js?v=3';
import { EventEmitter } from '../common/EventEmitter.js?v=3';
import { FileChooser } from '../common/FileChooser.js?v=3';
import { evaluationString, parsePDFOptions, timeout } from '../common/util.js?v=3';
import { assert } from '../util/assert.js?v=3';
import { bubble } from '../util/decorators.js?v=3';
import { Deferred } from '../util/Deferred.js?v=3';
import { stringToTypedArray } from '../util/encoding.js?v=3';
import { BidiElementHandle } from './ElementHandle.js?v=3';
import { BidiFrame } from './Frame.js?v=3';
import { BidiKeyboard, BidiMouse, BidiTouchscreen } from './Input.js?v=3';
import { rewriteNavigationError } from './util.js?v=3';
/**
