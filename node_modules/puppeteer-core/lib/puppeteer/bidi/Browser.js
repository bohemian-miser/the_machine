...
import { Browser, } from '../api/Browser.js?v=3';
import { ProtocolError, UnsupportedOperation } from '../common/Errors.js?v=3';
import { EventEmitter } from '../common/EventEmitter.js?v=3';
import { debugError } from '../common/util.js?v=3';
import { bubble } from '../util/decorators.js?v=3';
import { BidiBrowserContext } from './BrowserContext.js?v=3';
import { Session } from './core/Session.js?v=3';
import { BidiBrowserTarget } from './Target.js?v=3';
/**
 * @internal
 */
let BidiBrowser = (() => {
