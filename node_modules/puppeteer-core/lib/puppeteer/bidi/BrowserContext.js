...
import { WEB_PERMISSION_TO_PROTOCOL_PERMISSION } from '../api/Browser.js?v=3';
import { BrowserContext } from '../api/BrowserContext.js?v=3';
import { UnsupportedOperation } from '../common/Errors.js?v=3';
import { EventEmitter } from '../common/EventEmitter.js?v=3';
import { debugError, debugCatchError } from '../common/util.js?v=3';
import { assert } from '../util/assert.js?v=3';
import { bubble } from '../util/decorators.js?v=3';
import { UserContext } from './core/UserContext.js?v=3';
import { BidiPage, bidiToPuppeteerCookie, cdpSpecificCookiePropertiesFromPuppeteerToBidi, convertCookiesExpiryCdpToBiDi, convertCookiesPartitionKeyFromPuppeteerToBiDi, convertCookiesSameSiteCdpToBiDi, } from './Page.js?v=3';
import { BidiWorkerTarget } from './Target.js?v=3';
import { BidiFrameTarget, BidiPageTarget } from './Target.js?v=3';
/**
 * @internal
 */
