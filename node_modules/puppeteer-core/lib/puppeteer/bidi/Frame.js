...
import { combineLatest, defer, delayWhen, filter, first, firstValueFrom, map, of, race, raceWith, switchMap, } from '../../third_party/rxjs/rxjs.js?v=3';
import { Frame, throwIfDetached, } from '../api/Frame.js?v=3';
import { Accessibility } from '../cdp/Accessibility.js?v=3';
import { TargetCloseError, UnsupportedOperation } from '../common/Errors.js?v=3';
import { debugError, fromAbortSignal, fromEmitterEvent, timeout, } from '../common/util.js?v=3';
import { isErrorLike } from '../util/ErrorLike.js?v=3';
import { BidiCdpSession } from './CDPSession.js?v=3';
import { BidiDialog } from './Dialog.js?v=3';
import { BidiElementHandle } from './ElementHandle.js?v=3';
import { ExposableFunction } from './ExposedFunction.js?v=3';
import { BidiHTTPRequest, requests } from './HTTPRequest.js?v=3';
import { BidiFrameRealm } from './Realm.js?v=3';
import { getConsoleMessage, isConsoleLogEntry, isJavaScriptLogEntry, rewriteNavigationError, } from './util.js?v=3';
import { BidiWebWorker } from './WebWorker.js?v=3';
let BidiFrame = (() => {
    var _a;
