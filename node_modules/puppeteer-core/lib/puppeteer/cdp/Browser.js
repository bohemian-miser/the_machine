 ...
 */
import { Browser as BrowserBase, } from '../api/Browser.js?v=3';
import { CDPSessionEvent } from '../api/CDPSession.js?v=3';
import { Deferred } from '../util/Deferred.js?v=3';
import { CdpBrowserContext } from './BrowserContext.js?v=3';
import { CdpExtension } from './Extension.js?v=3';
import { DevToolsTarget, InitializationStatus, OtherTarget, PageTarget, WorkerTarget, } from './Target.js?v=3';
import { TargetManager } from './TargetManager.js?v=3';
/**
 * @internal
 */
