import { headersArray, HTTPRequest, STATUS_TEXTS, handleError, } from '../api/HTTPRequest.js?v=3';
import { debugError } from '../common/util.js?v=3';
import { mergeUint8Arrays, stringToBase64, stringToTypedArray, } from '../util/encoding.js?v=3';
/**
 * @internal
 */
