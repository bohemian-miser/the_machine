...
import { Frame, FrameEvent, throwIfDetached } from '../api/Frame.js?v=3';
import { UnsupportedOperation } from '../common/Errors.js?v=3';
import { debugCatchError } from '../common/util.js?v=3';
...
import { Accessibility } from './Accessibility.js?v=3';
...
import { LifecycleWatcher, } from './LifecycleWatcher.js?v=3';
import { CDP_BINDING_PREFIX } from './utils.js?v=3';
/**
 * @internal
 */
let CdpFrame = (() => {
