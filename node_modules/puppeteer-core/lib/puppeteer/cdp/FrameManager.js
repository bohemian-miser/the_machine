...
import { FrameEvent } from '../api/Frame.js?v=3';
import { EventEmitter } from '../common/EventEmitter.js?v=3';
import { debugError, PuppeteerURL, UTILITY_WORLD_NAME, debugCatchError, } from '../common/util.js?v=3';
import { assert } from '../util/assert.js?v=3';
import { Deferred } from '../util/Deferred.js?v=3';
import { disposeSymbol } from '../util/disposable.js?v=3';
import { isErrorLike } from '../util/ErrorLike.js?v=3';
import { CdpIssue } from './CdpIssue.js?v=3';
import { CdpPreloadScript } from './CdpPreloadScript.js?v=3';
import { isTargetClosedError } from './Connection.js?v=3';
import { CdpDeviceRequestPromptManager } from './DeviceRequestPrompt.js?v=3';
import { ExecutionContext } from './ExecutionContext.js?v=3';
import { CdpFrame } from './Frame.js?v=3';
import { FrameManagerEvent } from './FrameManagerEvents.js?v=3';
import { FrameTree } from './FrameTree.js?v=3';
import { IsolatedWorld } from './IsolatedWorld.js?v=3';
import { MAIN_WORLD, PUPPETEER_WORLD } from './IsolatedWorlds.js?v=3';
import { NetworkManager } from './NetworkManager.js?v=3';
