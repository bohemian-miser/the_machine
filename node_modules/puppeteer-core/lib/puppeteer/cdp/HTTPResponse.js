import { HTTPResponse } from '../api/HTTPResponse.js?v=3';
import { ProtocolError } from '../common/Errors.js?v=3';
import { SecurityDetails } from '../common/SecurityDetails.js?v=3';
import { Deferred } from '../util/Deferred.js?v=3';
import { stringToTypedArray } from '../util/encoding.js?v=3';
import { normalizeHeaderValue } from '../util/httpUtils.js?v=3';
/**
 * @internal
 */
