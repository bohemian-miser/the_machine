...
import { CallbackRegistry } from '../common/CallbackRegistry.js?v=3';
import { debug } from '../common/Debug.js?v=3';
import { ConnectionClosedError, TargetCloseError } from '../common/Errors.js?v=3';
import { EventEmitter } from '../common/EventEmitter.js?v=3';
import { createProtocolErrorMessage } from '../util/ErrorLike.js?v=3';
