...
import { debugError, isString, debugCatchError } from '../common/util.js?v=3';
import { assert } from '../util/assert.js?v=3';
import { DisposableStack } from '../util/disposable.js?v=3';
import { isErrorLike } from '../util/ErrorLike.js?v=3';
import { isTargetClosedError } from './Connection.js?v=3';
import { CdpHTTPRequest } from './HTTPRequest.js?v=3';
import { CdpHTTPResponse } from './HTTPResponse.js?v=3';
import { NetworkEventManager, } from './NetworkEventManager.js?v=3';
/**
 * @internal
 */
