...
import { transposeIterableHandle } from '../common/HandleIterator.js?v=3';
import { withSourcePuppeteerURLIfNone } from '../common/util.js?v=3';
...
import { FunctionLocator, NodeLocator, } from './locators/locators.js?v=3';
/**
