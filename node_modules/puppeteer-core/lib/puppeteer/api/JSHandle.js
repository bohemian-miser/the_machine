...
import { withSourcePuppeteerURLIfNone, debugCatchError } from '../common/util.js?v=3';
import { moveable, throwIfDisposed } from '../util/decorators.js?v=3';
import { disposeSymbol, asyncDisposeSymbol } from '../util/disposable.js?v=3';
/**
