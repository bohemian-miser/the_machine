...
import { firstValueFrom, from, map, race, timer, } from '../../third_party/rxjs/rxjs.js?v=3';
import { CdpBrowser } from '../cdp/Browser.js?v=3';
import { Connection } from '../cdp/Connection.js?v=3';
import { assertSupportedUrlRestrictions } from '../common/BrowserConnector.js?v=3';
import { TimeoutError } from '../common/Errors.js?v=3';
import { debugError, DEFAULT_VIEWPORT } from '../common/util.js?v=3';
import { createIncrementalIdGenerator, } from '../util/incremental-id-generator.js?v=3';
import { NodeWebSocketTransport as WebSocketTransport } from './NodeWebSocketTransport.js?v=3';
import { PipeTransport } from './PipeTransport.js?v=3';
/**
 * @internal
 */
