 ...
 */
var _a;
import { ChromiumBidi, InvalidArgumentException, } from '../../../protocol/protocol.js?v=3';
import { Buffer } from '../../../utils/Buffer.js?v=3';
import { DefaultMap } from '../../../utils/DefaultMap.js?v=3';
import { EventEmitter } from '../../../utils/EventEmitter.js?v=3';
import { IdWrapper } from '../../../utils/IdWrapper.js?v=3';
import { OutgoingMessage } from '../../OutgoingMessage.js?v=3';
import { assertSupportedEvent } from './events.js?v=3';
import { difference, SubscriptionManager, unrollEvents, } from './SubscriptionManager.js?v=3';
class EventWrapper {
