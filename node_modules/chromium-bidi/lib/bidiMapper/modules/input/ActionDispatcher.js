 ...
 */
import { InvalidArgumentException, MoveTargetOutOfBoundsException, NoSuchElementException, } from '../../../protocol/protocol.js?v=3';
import { assert } from '../../../utils/assert.js?v=3';
import { isSingleComplexGrapheme, isSingleGrapheme, } from '../../../utils/graphemeTools.js?v=3';
import { PointerSource, } from './InputSource.js?v=3';
import { getKeyCode, getKeyLocation, getNormalizedKey } from './keyUtils.js?v=3';
import { KeyToKeyCode } from './USKeyboardLayout.js?v=3';
