import { Bluetooth, Speculation } from '../../../protocol/chromium-bidi.js?v=3';
import { UnknownErrorException, UnsupportedOperationException, } from '../../../protocol/protocol.js?v=3';
import { Deferred } from '../../../utils/Deferred.js?v=3';
import { LogType } from '../../../utils/log.js?v=3';
import { BrowsingContextImpl } from '../context/BrowsingContextImpl.js?v=3';
import { LogManager } from '../log/LogManager.js?v=3';
import { MAX_TOTAL_COLLECTED_SIZE, } from '../network/NetworkStorage.js?v=3';
