import { NoSuchUserContextException, UnableToSetCookieException, } from '../../../protocol/protocol.js?v=3';
import { assert } from '../../../utils/assert.js?v=3';
import { LogType } from '../../../utils/log.js?v=3';
import { NetworkProcessor } from '../network/NetworkProcessor.js?v=3';
import { bidiToCdpCookie, cdpToBiDiCookie, deserializeByteValue, } from '../network/NetworkUtils.js?v=3';
/**
