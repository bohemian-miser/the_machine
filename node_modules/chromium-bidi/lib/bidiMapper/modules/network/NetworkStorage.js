import { InvalidArgumentException, NoSuchInterceptException, NoSuchNetworkDataException, UnsupportedOperationException, } from '../../../protocol/protocol.js?v=3';
import { uuidv4 } from '../../../utils/uuid.js?v=3';
import { CollectorsStorage } from './CollectorsStorage.js?v=3';
import { NetworkRequest } from './NetworkRequest.js?v=3';
import { matchUrlPattern } from './NetworkUtils.js?v=3';
