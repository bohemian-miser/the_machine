 ...
 */
var _a;
import { ChromiumBidi, } from '../../../protocol/protocol.js?v=3';
import { assert } from '../../../utils/assert.js?v=3';
import { DefaultMap } from '../../../utils/DefaultMap.js?v=3';
import { Deferred } from '../../../utils/Deferred.js?v=3';
import { LogType } from '../../../utils/log.js?v=3';
import { bidiBodySizeFromCdpPostDataEntries, bidiNetworkHeadersFromCdpNetworkHeaders, cdpAuthChallengeResponseFromBidiAuthContinueWithAuthAction, cdpFetchHeadersFromBidiNetworkHeaders, cdpToBiDiCookie, computeHeadersSize, getTiming, networkHeaderFromCookieHeaders, stringToBase64, } from './NetworkUtils.js?v=3';
