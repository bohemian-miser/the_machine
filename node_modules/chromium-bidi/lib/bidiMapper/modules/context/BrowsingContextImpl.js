 ...
 */
var _a;
import { ChromiumBidi, InvalidArgumentException, InvalidSelectorException, NoSuchElementException, NoSuchFrameException, NoSuchHistoryEntryException, NoSuchNodeException, UnableToCaptureScreenException, UnknownErrorException, UnsupportedOperationException, } from '../../../protocol/protocol.js?v=3';
import { assert } from '../../../utils/assert.js?v=3';
import { Deferred } from '../../../utils/Deferred.js?v=3';
import { LogType } from '../../../utils/log.js?v=3';
import { getTimestamp } from '../../../utils/time.js?v=3';
import { inchesFromCm } from '../../../utils/unitConversions.js?v=3';
import { uuidv4 } from '../../../utils/uuid.js?v=3';
import { getSharedId, parseSharedId } from '../script/SharedId.js?v=3';
import { WindowRealm } from '../script/WindowRealm.js?v=3';
import { NavigationResult, NavigationTracker, } from './NavigationTracker.js?v=3';
