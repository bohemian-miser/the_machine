 ...
 * @license
 */
import { BidiServer } from '../bidiMapper/BidiMapper.js?v=3';
import { MapperCdpConnection } from '../cdp/CdpConnection.js?v=3';
import { LogType } from '../utils/log.js?v=3';
import { BidiParser } from './BidiParser.js?v=3';
import { generatePage, log } from './mapperTabPage.js?v=3';
import { WindowBidiTransport, WindowCdpTransport } from './Transport.js?v=3';
generatePage();
